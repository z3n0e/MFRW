...
def _resnet_divided(arch, block, layers, pretrained, progress, **kwargs):
    model = ResNet_1(block, layers, **kwargs)
    model_2 = ResNet_2(block, layers, **kwargs)
    if pretrained:
        model_dict = model.state_dict()
        state_dict = load_state_dict_from_url(model_urls[arch],
                                              progress=progress)
...
def resnet34_divided(pretrained=False, progress=True, **kwargs):
    r"""ResNet-34 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_divided('resnet34', BasicBlock, [3, 4, 6, 3], pretrained, progress,
                           **kwargs)
...
def resnet50_divided(pretrained=False, progress=True, **kwargs):
    r"""ResNet-50 model from
    `"Deep Residual Learning for Image Recognition" <https://arxiv.org/pdf/1512.03385.pdf>`_
    ...
    Args:
        ...
        progress (bool): If True, displays a progress bar of the download to stderr
    """
    return _resnet_divided('resnet50', Bottleneck, [3, 4, 6, 3], pretrained, progress,
                           **kwargs)
